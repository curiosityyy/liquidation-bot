...
mod iuniswapv2router01_mod {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for IUniswapV2Router01<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> IUniswapV2Router01<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), IUNISWAPV2ROUTER01_ABI.clone(), client)
                .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                IUNISWAPV2ROUTER01_BYTECODE.clone().into(),
                client,
            );
    ...
    impl ethers::core::abi::AbiDecode for IUniswapV2Router01Calls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(IUniswapV2Router01Calls::RemoveLiquidityETHWithPermit(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IUniswapV2Router01Calls::RemoveLiquidityWithPermit(decoded));
            }
            if let Ok(decoded) =
                <SwapETHForExactTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniswapV2Router01Calls::SwapETHForExactTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactETHForTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniswapV2Router01Calls::SwapExactETHForTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactTokensForETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniswapV2Router01Calls::SwapExactTokensForETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IUniswapV2Router01Calls::SwapExactTokensForTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapTokensForExactETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniswapV2Router01Calls::SwapTokensForExactETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IUniswapV2Router01Calls::SwapTokensForExactTokens(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for IUniswapV2Router01Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                IUniswapV2Router01Calls::Weth(element) => element.encode(),
                IUniswapV2Router01Calls::AddLiquidity(element) => element.encode(),
                IUniswapV2Router01Calls::AddLiquidityETH(element) => element.encode(),
                IUniswapV2Router01Calls::Factory(element) => element.encode(),
                IUniswapV2Router01Calls::GetAmountIn(element) => element.encode(),
                IUniswapV2Router01Calls::GetAmountOut(element) => element.encode(),
                IUniswapV2Router01Calls::GetAmountsIn(element) => element.encode(),
                IUniswapV2Router01Calls::GetAmountsOut(element) => element.encode(),
                IUniswapV2Router01Calls::Quote(element) => element.encode(),
                IUniswapV2Router01Calls::RemoveLiquidity(element) => element.encode(),
                IUniswapV2Router01Calls::RemoveLiquidityETH(element) => element.encode(),
                IUniswapV2Router01Calls::RemoveLiquidityETHWithPermit(element) => element.encode(),
                IUniswapV2Router01Calls::RemoveLiquidityWithPermit(element) => element.encode(),
                IUniswapV2Router01Calls::SwapETHForExactTokens(element) => element.encode(),
                IUniswapV2Router01Calls::SwapExactETHForTokens(element) => element.encode(),
                IUniswapV2Router01Calls::SwapExactTokensForETH(element) => element.encode(),
                IUniswapV2Router01Calls::SwapExactTokensForTokens(element) => element.encode(),
                IUniswapV2Router01Calls::SwapTokensForExactETH(element) => element.encode(),
                IUniswapV2Router01Calls::SwapTokensForExactTokens(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for IUniswapV2Router01Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IUniswapV2Router01Calls::Weth(element) => element.fmt(f),
                IUniswapV2Router01Calls::AddLiquidity(element) => element.fmt(f),
                IUniswapV2Router01Calls::AddLiquidityETH(element) => element.fmt(f),
                IUniswapV2Router01Calls::Factory(element) => element.fmt(f),
                IUniswapV2Router01Calls::GetAmountIn(element) => element.fmt(f),
                IUniswapV2Router01Calls::GetAmountOut(element) => element.fmt(f),
                IUniswapV2Router01Calls::GetAmountsIn(element) => element.fmt(f),
                IUniswapV2Router01Calls::GetAmountsOut(element) => element.fmt(f),
                IUniswapV2Router01Calls::Quote(element) => element.fmt(f),
                IUniswapV2Router01Calls::RemoveLiquidity(element) => element.fmt(f),
                IUniswapV2Router01Calls::RemoveLiquidityETH(element) => element.fmt(f),
                IUniswapV2Router01Calls::RemoveLiquidityETHWithPermit(element) => element.fmt(f),
                IUniswapV2Router01Calls::RemoveLiquidityWithPermit(element) => element.fmt(f),
                IUniswapV2Router01Calls::SwapETHForExactTokens(element) => element.fmt(f),
                IUniswapV2Router01Calls::SwapExactETHForTokens(element) => element.fmt(f),
                IUniswapV2Router01Calls::SwapExactTokensForETH(element) => element.fmt(f),
                IUniswapV2Router01Calls::SwapExactTokensForTokens(element) => element.fmt(f),
                IUniswapV2Router01Calls::SwapTokensForExactETH(element) => element.fmt(f),
                IUniswapV2Router01Calls::SwapTokensForExactTokens(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<WethCall> for IUniswapV2Router01Calls {
        fn from(var: WethCall) -> Self {
            IUniswapV2Router01Calls::Weth(var)
        }
    }
    impl ::std::convert::From<AddLiquidityCall> for IUniswapV2Router01Calls {
        fn from(var: AddLiquidityCall) -> Self {
            IUniswapV2Router01Calls::AddLiquidity(var)
        }
    }
    impl ::std::convert::From<AddLiquidityETHCall> for IUniswapV2Router01Calls {
        fn from(var: AddLiquidityETHCall) -> Self {
            IUniswapV2Router01Calls::AddLiquidityETH(var)
        }
    }
    impl ::std::convert::From<FactoryCall> for IUniswapV2Router01Calls {
        fn from(var: FactoryCall) -> Self {
            IUniswapV2Router01Calls::Factory(var)
        }
    }
    impl ::std::convert::From<GetAmountInCall> for IUniswapV2Router01Calls {
        fn from(var: GetAmountInCall) -> Self {
            IUniswapV2Router01Calls::GetAmountIn(var)
        }
    }
    impl ::std::convert::From<GetAmountOutCall> for IUniswapV2Router01Calls {
        fn from(var: GetAmountOutCall) -> Self {
            IUniswapV2Router01Calls::GetAmountOut(var)
        }
    }
    impl ::std::convert::From<GetAmountsInCall> for IUniswapV2Router01Calls {
        fn from(var: GetAmountsInCall) -> Self {
            IUniswapV2Router01Calls::GetAmountsIn(var)
        }
    }
    impl ::std::convert::From<GetAmountsOutCall> for IUniswapV2Router01Calls {
        fn from(var: GetAmountsOutCall) -> Self {
            IUniswapV2Router01Calls::GetAmountsOut(var)
        }
    }
    impl ::std::convert::From<QuoteCall> for IUniswapV2Router01Calls {
        fn from(var: QuoteCall) -> Self {
            IUniswapV2Router01Calls::Quote(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityCall> for IUniswapV2Router01Calls {
        fn from(var: RemoveLiquidityCall) -> Self {
            IUniswapV2Router01Calls::RemoveLiquidity(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHCall> for IUniswapV2Router01Calls {
        fn from(var: RemoveLiquidityETHCall) -> Self {
            IUniswapV2Router01Calls::RemoveLiquidityETH(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHWithPermitCall> for IUniswapV2Router01Calls {
        fn from(var: RemoveLiquidityETHWithPermitCall) -> Self {
            IUniswapV2Router01Calls::RemoveLiquidityETHWithPermit(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityWithPermitCall> for IUniswapV2Router01Calls {
        fn from(var: RemoveLiquidityWithPermitCall) -> Self {
            IUniswapV2Router01Calls::RemoveLiquidityWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapETHForExactTokensCall> for IUniswapV2Router01Calls {
        fn from(var: SwapETHForExactTokensCall) -> Self {
            IUniswapV2Router01Calls::SwapETHForExactTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactETHForTokensCall> for IUniswapV2Router01Calls {
        fn from(var: SwapExactETHForTokensCall) -> Self {
            IUniswapV2Router01Calls::SwapExactETHForTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForETHCall> for IUniswapV2Router01Calls {
        fn from(var: SwapExactTokensForETHCall) -> Self {
            IUniswapV2Router01Calls::SwapExactTokensForETH(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForTokensCall> for IUniswapV2Router01Calls {
        fn from(var: SwapExactTokensForTokensCall) -> Self {
            IUniswapV2Router01Calls::SwapExactTokensForTokens(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactETHCall> for IUniswapV2Router01Calls {
        fn from(var: SwapTokensForExactETHCall) -> Self {
            IUniswapV2Router01Calls::SwapTokensForExactETH(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactTokensCall> for IUniswapV2Router01Calls {
        fn from(var: SwapTokensForExactTokensCall) -> Self {
            IUniswapV2Router01Calls::SwapTokensForExactTokens(var)
        }
    }
}
