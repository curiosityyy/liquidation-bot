...
interface ICreditFacade is ICreditFacadeEvents, ICreditFacadeExceptions, IVersion {
    ...
    /// @return Length of allowedContracts
    function allowedContractsLength() external view returns (uint256);

    /// @return Allowed contract address at i-th position
    function allowedContract(uint256 i) external view returns (address);
