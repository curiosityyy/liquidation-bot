pub use icreditfacadeexceptions_mod::*;
#[allow(clippy::too_many_arguments)]
mod icreditfacadeexceptions_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> ICreditFacadeExceptions<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(
                address.into(),
                ICREDITFACADEEXCEPTIONS_ABI.clone(),
                client,
            )
            .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ICREDITFACADEEXCEPTIONS_ABI.clone(),
                ICREDITFACADEEXCEPTIONS_BYTECODE.clone().into(),
                client,
            );
