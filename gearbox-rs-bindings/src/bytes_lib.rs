...
mod byteslib_mod {
    ...
    pub static BYTESLIB_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "" . parse () . expect ("invalid bytecode")
        });
    #[derive(Clone)]
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for BytesLib<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> BytesLib<M> {
