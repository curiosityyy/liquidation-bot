pub use icreditmanagerexceptions_mod::*;
#[allow(clippy::too_many_arguments)]
mod icreditmanagerexceptions_mod {
    ...
    #[doc = "ICreditManagerExceptions was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    pub static ICREDITMANAGEREXCEPTIONS_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
    ...
    pub static ICREDITMANAGEREXCEPTIONS_BYTECODE: ethers::contract::Lazy<
        ethers::core::types::Bytes,
    > = ethers::contract::Lazy::new(|| "0x".parse().expect("invalid bytecode"));
    #[derive(Clone)]
    pub struct ICreditManagerExceptions<M>(ethers::contract::Contract<M>);
    impl<M> std::ops::Deref for ICreditManagerExceptions<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for ICreditManagerExceptions<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(ICreditManagerExceptions))
                .field(&self.address())
                .finish()
        }
    }
    impl<'a, M: ethers::providers::Middleware> ICreditManagerExceptions<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(
                address.into(),
                ICREDITMANAGEREXCEPTIONS_ABI.clone(),
                client,
            )
            .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ICREDITMANAGEREXCEPTIONS_ABI.clone(),
                ICREDITMANAGEREXCEPTIONS_BYTECODE.clone().into(),
                client,
            );
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>>
        for ICreditManagerExceptions<M>
    {
