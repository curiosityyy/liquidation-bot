pub use icurvepool3assets_mod::*;
#[allow(clippy::too_many_arguments)]
mod icurvepool3assets_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> ICurvePool3Assets<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), ICURVEPOOL3ASSETS_ABI.clone(), client)
                .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ICURVEPOOL3ASSETS_ABI.clone(),
                ICURVEPOOL3ASSETS_BYTECODE.clone().into(),
                client,
            );
        ...
        #[doc = "Calls the contract's `add_liquidity` (0x4515cef3) function"]
        pub fn add_liquidity(
            ...
            self.0
                .method_hash([69, 21, 206, 243], (amounts, min_mint_amount))
        ...
        #[doc = "Calls the contract's `remove_liquidity` (0xecb586a5) function"]
        pub fn remove_liquidity(
            &self,
            amount: ethers::core::types::U256,
            min_amounts: [ethers::core::types::U256; 3usize],
        ) -> ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([236, 181, 134, 165], (amount, min_amounts))
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `remove_liquidity_imbalance` (0x9fdaea0c) function"]
        pub fn remove_liquidity_imbalance(
            ...
            self.0
                .method_hash([159, 218, 234, 12], (amounts, max_burn_amount))
                .expect("method not found (this should never happen)")
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>>
        for ICurvePool3Assets<M>
    {
        fn from(contract: ethers::contract::Contract<M>) -> Self {
            Self(contract)
        }
    }
    #[doc = "Container type for all input parameters for the `add_liquidity`function with signature `add_liquidity(uint256[3],uint256)` and selector `[69, 21, 206, 243]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[ethcall(name = "add_liquidity", abi = "add_liquidity(uint256[3],uint256)")]
    ...
    #[doc = "Container type for all input parameters for the `remove_liquidity`function with signature `remove_liquidity(uint256,uint256[3])` and selector `[236, 181, 134, 165]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[ethcall(
        ...
        abi = "remove_liquidity(uint256,uint256[3])"
    )]
    pub struct RemoveLiquidityCall {
        pub amount: ethers::core::types::U256,
        pub min_amounts: [ethers::core::types::U256; 3usize],
    }
    #[doc = "Container type for all input parameters for the `remove_liquidity_imbalance`function with signature `remove_liquidity_imbalance(uint256[3],uint256)` and selector `[159, 218, 234, 12]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[ethcall(
        ...
        abi = "remove_liquidity_imbalance(uint256[3],uint256)"
    )]
    ...
    pub enum ICurvePool3AssetsCalls {
    ...
    impl ethers::core::abi::AbiDecode for ICurvePool3AssetsCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(ICurvePool3AssetsCalls::RemoveLiquidityImbalance(decoded));
            }
            if let Ok(decoded) =
                <RemoveLiquidityOneCoinCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(ICurvePool3AssetsCalls::RemoveLiquidityOneCoin(decoded));
            }
            if let Ok(decoded) = <TokenCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(ICurvePool3AssetsCalls::Token(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for ICurvePool3AssetsCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ICurvePool3AssetsCalls::AddLiquidity(element) => element.encode(),
                ICurvePool3AssetsCalls::Coins(element) => element.encode(),
                ICurvePool3AssetsCalls::Exchange(element) => element.encode(),
                ICurvePool3AssetsCalls::ExchangeUnderlying(element) => element.encode(),
                ICurvePool3AssetsCalls::GetDy(element) => element.encode(),
                ICurvePool3AssetsCalls::GetDyUnderlying(element) => element.encode(),
                ICurvePool3AssetsCalls::GetVirtualPrice(element) => element.encode(),
                ICurvePool3AssetsCalls::RemoveLiquidity(element) => element.encode(),
                ICurvePool3AssetsCalls::RemoveLiquidityImbalance(element) => element.encode(),
                ICurvePool3AssetsCalls::RemoveLiquidityOneCoin(element) => element.encode(),
                ICurvePool3AssetsCalls::Token(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for ICurvePool3AssetsCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ICurvePool3AssetsCalls::AddLiquidity(element) => element.fmt(f),
                ICurvePool3AssetsCalls::Coins(element) => element.fmt(f),
                ICurvePool3AssetsCalls::Exchange(element) => element.fmt(f),
                ICurvePool3AssetsCalls::ExchangeUnderlying(element) => element.fmt(f),
                ICurvePool3AssetsCalls::GetDy(element) => element.fmt(f),
                ICurvePool3AssetsCalls::GetDyUnderlying(element) => element.fmt(f),
                ICurvePool3AssetsCalls::GetVirtualPrice(element) => element.fmt(f),
                ICurvePool3AssetsCalls::RemoveLiquidity(element) => element.fmt(f),
                ICurvePool3AssetsCalls::RemoveLiquidityImbalance(element) => element.fmt(f),
                ICurvePool3AssetsCalls::RemoveLiquidityOneCoin(element) => element.fmt(f),
                ICurvePool3AssetsCalls::Token(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AddLiquidityCall> for ICurvePool3AssetsCalls {
        fn from(var: AddLiquidityCall) -> Self {
            ICurvePool3AssetsCalls::AddLiquidity(var)
        }
    }
    impl ::std::convert::From<CoinsCall> for ICurvePool3AssetsCalls {
        fn from(var: CoinsCall) -> Self {
            ICurvePool3AssetsCalls::Coins(var)
        }
    }
    impl ::std::convert::From<ExchangeCall> for ICurvePool3AssetsCalls {
        fn from(var: ExchangeCall) -> Self {
            ICurvePool3AssetsCalls::Exchange(var)
        }
    }
    impl ::std::convert::From<ExchangeUnderlyingCall> for ICurvePool3AssetsCalls {
        fn from(var: ExchangeUnderlyingCall) -> Self {
            ICurvePool3AssetsCalls::ExchangeUnderlying(var)
        }
    }
    impl ::std::convert::From<GetDyCall> for ICurvePool3AssetsCalls {
        fn from(var: GetDyCall) -> Self {
            ICurvePool3AssetsCalls::GetDy(var)
        }
    }
    impl ::std::convert::From<GetDyUnderlyingCall> for ICurvePool3AssetsCalls {
        fn from(var: GetDyUnderlyingCall) -> Self {
            ICurvePool3AssetsCalls::GetDyUnderlying(var)
        }
    }
    impl ::std::convert::From<GetVirtualPriceCall> for ICurvePool3AssetsCalls {
        fn from(var: GetVirtualPriceCall) -> Self {
            ICurvePool3AssetsCalls::GetVirtualPrice(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityCall> for ICurvePool3AssetsCalls {
        fn from(var: RemoveLiquidityCall) -> Self {
            ICurvePool3AssetsCalls::RemoveLiquidity(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityImbalanceCall> for ICurvePool3AssetsCalls {
        fn from(var: RemoveLiquidityImbalanceCall) -> Self {
            ICurvePool3AssetsCalls::RemoveLiquidityImbalance(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityOneCoinCall> for ICurvePool3AssetsCalls {
        fn from(var: RemoveLiquidityOneCoinCall) -> Self {
            ICurvePool3AssetsCalls::RemoveLiquidityOneCoin(var)
        }
    }
    impl ::std::convert::From<TokenCall> for ICurvePool3AssetsCalls {
        fn from(var: TokenCall) -> Self {
            ICurvePool3AssetsCalls::Token(var)
        }
    }
}
