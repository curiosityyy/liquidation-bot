pub use enumerableset_mod::*;
#[allow(clippy::too_many_arguments)]
mod enumerableset_mod {
    ...
    pub static ENUMERABLESET_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "" . parse () . expect ("invalid bytecode")
        });
    #[derive(Clone)]
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for EnumerableSet<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> EnumerableSet<M> {
